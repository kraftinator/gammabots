class TradingStrategyInterpreter
  ...
  def binding_from_variables
    b = binding
    allowed_keys = [:cpr, :ppr, :rhi, :vst, :vlt, :ssd, :lsd, :ibp, :lbp, :scn, :bcn, :bta, :mam, :hip, :hlt, :lip, :llt, :lta, :lba, :lsp, :lps, :crt, :cma, :pcm, :plm, :lmc, :hma, :lma, :hmt, :lmt, :lmi, :tma, :lcp, :scp, :bpp, :ndp, :nd2]
