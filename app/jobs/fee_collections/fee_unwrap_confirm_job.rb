# app/jobs/fee_collections/fee_unwrap_confirm_job.rb
module FeeCollections
  class FeeUnwrapConfirmJob < ApplicationJob
    ...
    def perform(fee_collection_id, attempt = 1)
      ...
      return unless fee && fee.unwrap_status == "submitted" && fee.unwrap_tx_hash.present?
      ...
      if receipt["status"].to_i == 1
        ...
        FeeCollections::FeeDepositJob.perform_later(fee.id)
      else
        fee.update!(unwrap_status: "failed")
