...
ActiveRecord::Schema[7.2].define(version: 2026_01_20_203140) do
  ...
  create_table "bots", force: :cascade do |t|
    ...
    t.datetime "deactivation_requested_at"
    ...
    t.index ["deactivation_requested_at"], name: "index_bots_on_deactivation_requested_at"
