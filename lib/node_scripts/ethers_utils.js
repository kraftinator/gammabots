...
async function getTokenPrice(tokenA, token0Decimals, tokenB, token1Decimals, providerUrl) {
    ...
    try {
        ...
        //const poolAddress = await factoryContract.getPool(token0, token1, 10000);
